...
export const ListStatisticCard: React.FC<ListStatisticCardProps> = ({
  ...
  return (
    <div className="flex flex-col flex-1 py-px text-sm bg-violet-100 rounded-lg border border-solid border-stone-950 border-opacity-10 min-w-[400px] max-md:max-w-full">
      <div className="flex flex-wrap gap-5 justify-between px-6 py-4 w-full font-semibold text-white rounded-lg border-t border-r border-l bg-slate-700 border-slate-300 shadow-[0px_2px_25px_rgba(0,0,0,0.15)] max-md:px-5 max-md:max-w-full">
        <div>{title}</div>
      ...
      <div className="flex overflow-hidden flex-col px-5 py-2.5 max-md:max-w-full">
        {loading ? (
          ...
          <>
            <ol className="text-indigo-950 list-decimal pl-5">
